...
export const PILLARS: Pillar[] = [
  {
    ...
    drivers: 'BS&nbsp;5839-1:2025 brings the latest revision into force, the Building Safety Act 2022 tightens the golden thread, and Awaab&rsquo;s Law reshapes landlord response times. Detection, evacuation and monitoring are no longer optional line items.',
  },
  {
    id: 'passive',
    no: '02',
