...
export const PILLARS: Pillar[] = [
  {
    ...
    drivers: 'The current edition of BS&nbsp;5839-1 governs fire detection and alarm in non-domestic premises, the Building Safety Act 2022 tightens the golden thread, and Awaab&rsquo;s Law reshapes landlord response times. Detection, evacuation and monitoring are no longer optional line items.',
  },
  {
    id: 'passive',
    no: '02',
...
export const SECTORS: Sector[] = [
  { name: 'Residential &amp; Social Housing', slug: 'sector/residential-social-housing', colour: COL.green,
    ...
    drivers: 'Building Safety Act 2022 golden-thread obligations · Awaab&rsquo;s Law response-time duties · BS 5839-1 fire detection · BS 8629 evacuation alert systems · Homes England Interim Measures Alarm Fund (IMAF) eligibility.',
