...
// ——— Manufacturers + suppliers we install / specify ———
// Source: 01-brand/manufacturers-inventory.md (2026-06-25, ~40 entries across 8 categories).
// Featured-12 surfaced on home page; full set lives at /manufacturers/.
// Logos lifted in a later pass — text-tile fallback in interim, same as CLIENTS.
...
const MANUFACTURERS = [
  ...
  // Ventilation + AOV + smoke control (8 — top of 14 in inventory)
